...
## [1.42.0](https://github.com/egarlock/no-mistakes/compare/v1.41.0...v1.42.0) (2026-07-23)
...
* **pipeline:** custom command steps + per-step options ([#2](https://github.com/egarlock/no-mistakes/issues/2)) ([8f878da](https://github.com/egarlock/no-mistakes/commit/8f878daff7d9259013329f67425d59f7c9422d89))
* **pipeline:** per-repo steps: list to enable/disable/reorder built-in steps ([1b2fdcc](https://github.com/egarlock/no-mistakes/commit/1b2fdcc92f6155d3160aea80c45f1453846d85c3))
...
* **pipeline:** skill-driven read-only validation steps (type: skill, mode: review) ([#4](https://github.com/egarlock/no-mistakes/issues/4)) ([78196a0](https://github.com/egarlock/no-mistakes/commit/78196a0f2701d96792dadc7d1797a5f823764bb8))
...
* **profiles:** shared gate profiles PR-A (trusted profile: field, host-local &lt;NM_HOME&gt;/profiles) ([#7](https://github.com/egarlock/no-mistakes/issues/7)) ([d919759](https://github.com/egarlock/no-mistakes/commit/d9197594185bf73432facfd29e0a9fd11e443361))
...
* **steps:** iOS-oriented quick wins (Swift test detection, rebase sanitize, evidence hint, docs) ([#5](https://github.com/egarlock/no-mistakes/issues/5)) ([e0e487b](https://github.com/egarlock/no-mistakes/commit/e0e487b841bf7ae2d950c94b66a0c87f02abe9f0))
* **steps:** mode: revise skill steps (mutate + commit + re-review) + revision-and-review skill ([#6](https://github.com/egarlock/no-mistakes/issues/6)) ([9733eac](https://github.com/egarlock/no-mistakes/commit/9733eac1d85fd86f7e795fafc8ef0b7d9d123065))
...
* **branchsync:** fail-safe equivalence detection on git &lt; 2.40 ([c858b71](https://github.com/egarlock/no-mistakes/commit/c858b712402375560b6c90f240124cbcf79adb3c))
...
* **security:** fail-closed fixes from cross-cutting review of config-driven steps + shared profiles ([#8](https://github.com/egarlock/no-mistakes/issues/8)) ([e4e8f22](https://github.com/egarlock/no-mistakes/commit/e4e8f2284d170988d7f350603b563055ca5ce6fc))
